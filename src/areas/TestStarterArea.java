...
public class TestStarterArea extends Area {
	...
	protected void registerNewActions(DisplayAreas area) {
		...
		area.registerAction(NavigationArea.ButtonNames.CENTER, new PrintAction("center clicked", area.getTextArea(), PrintAction.PrintOptions.APPEND));
		area.registerAction(NavigationArea.ButtonNames.CENTER, new ButtonTextChangeAction("center clicked", area.getActionInfoArea().getNavigationArea().getButton(ButtonNames.CENTER)));
	}
}
